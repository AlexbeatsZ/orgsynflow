...
| Gaussian/xTB/CREST/PySCF/Psi4/cclib/GoodVibes | Not ML-weight modules. They are quantum chemistry, conformer search, parsing, or thermochemistry tools. | Local/WSL toolchain is already available as documented in `AGENTS.md`. | No training weights required. |
